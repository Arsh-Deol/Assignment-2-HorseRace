...
namespace HorseRace
{
    ...
    public partial class HorseRaceForm : Form
    {
        ...
        public void Start()
        {
            ...
            Data.gambler[0] = new Gambler() { cash = 50, label = label_better1, radioBtn = radioButton1, name = "Aman" };
            Data.gambler[1] = new Gambler() { cash = 50, label = label_better2, radioBtn = radioButton2, name = "Arnav" };
            Data.gambler[2] = new Gambler() { cash = 50, label = label_better3, radioBtn = radioButton3, name = "Mona" };
        ...
        public void ResetBets()
        {
            for (int i = 0; i < 3; i++)
            {
                label_better1.Text = "Aman hasn't placed any bets.";
                label_better2.Text = "Arnav hasn't placed any bets.";
                label_better3.Text = "Mona hasn't placed any bets.";
            }
        }
